      ...
      <div className="bg-[#0F0F12] border border-slate-800 rounded-xl p-8 max-w-sm w-full shadow-2xl flex flex-col items-center">
        {loading ? (
          ...
          <>
            ...
            {error && (
              <div className="w-full bg-red-500/10 border border-red-500/20 text-red-500 text-xs p-3 rounded mb-4 text-center">
                {error}
              </div>
            )}
            ...
            <button 
              ...
              className="w-full bg-white text-slate-900 hover:bg-slate-200 transition-colors py-3 rounded-lg font-medium flex items-center justify-center space-x-3 mb-4"
            >
